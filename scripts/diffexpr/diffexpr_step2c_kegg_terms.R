...
go_lrt$interaction <- compareCluster(geneClusters = comp_list_interaction_entrezid,
                                     ...
                                     fun = enrichKEGG, qvalueCutoff = 0.05)
## Write go objects
saveRDS(go_housing,file = "data_output/2024-1_diffexpr_output/kegg_housing.Rds")
saveRDS(go_genotype,file = "data_output/2024-1_diffexpr_output/kegg_genotype.Rds")
saveRDS(go_lrt,file = "data_output/2024-1_diffexpr_output/kegg_lrt.Rds")
